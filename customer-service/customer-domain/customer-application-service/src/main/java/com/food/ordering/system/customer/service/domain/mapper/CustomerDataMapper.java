...
public class CustomerDataMapper {
    public Customer toCustomer(CreateCustomerCommand createCustomerCommand) {
    ...
    public CreateCustomerResponse toCreateCustomerResponse(Customer customer, String message) {
