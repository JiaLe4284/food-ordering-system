...
public class PaymentMessagingDataMapper {
    ...
    toPaymentResponseAvroModel(PaymentCompletedEvent paymentCompletedEvent) {
    ...
    public PaymentResponseAvroModel
    toPaymentResponseAvroModel(PaymentCancelledEvent paymentCancelledEvent) {
        return PaymentResponseAvroModel.newBuilder()
                .setId(UUID.randomUUID().toString())
                .setSagaId("")
    ...
    public PaymentResponseAvroModel
    toPaymentResponseAvroModel(PaymentFailedEvent paymentFailedEvent) {
        return PaymentResponseAvroModel.newBuilder()
                .setId(UUID.randomUUID().toString())
                .setSagaId("")
    ...
    public PaymentRequest toPaymentRequest(PaymentRequestAvroModel paymentRequestAvroModel) {
