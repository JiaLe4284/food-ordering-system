...
public class CreditHistoryRepositoryImpl implements CreditHistoryRepository {
    ...
    public CreditHistory save(CreditHistory creditHistory) {
        return creditHistoryDataAccessMapper.toCreditHistory(creditHistoryJpaRepository
                .save(creditHistoryDataAccessMapper.toCreditHistoryEntity(creditHistory)));
    }
        ...
        return creditHistory
                .map(creditHistoryList ->
                        creditHistoryList.stream()
                                .map(creditHistoryDataAccessMapper::toCreditHistory)
