...
public class CreditHistoryDataAccessMapper {
    public CreditHistory toCreditHistory(CreditHistoryEntity creditHistoryEntity) {
    ...
    public CreditHistoryEntity toCreditHistoryEntity(CreditHistory creditHistory) {
