...
public class OrderCreateHelper {
    ...
    private Restaurant checkRestaurant(CreateOrderCommand createOrderCommand) {
        Restaurant restaurantFromReq = orderDataMapper.toRestaurantFrom(createOrderCommand);
        Optional<Restaurant> restaurantFromDb = restaurantRepository.findRestaurantInformation(restaurantFromReq);

        if (restaurantFromDb.isEmpty()) {
            log.warn("Could not find restaurant with restaurant id: {}", createOrderCommand.getRestaurantId());
            throw new OrderDomainException("Could not find restaurant with restaurant id: " +
                    createOrderCommand.getRestaurantId());
        }
        return restaurantFromDb.get();
    }
