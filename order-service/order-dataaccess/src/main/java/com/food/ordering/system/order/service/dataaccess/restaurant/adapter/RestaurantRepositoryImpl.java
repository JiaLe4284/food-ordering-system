...
public class RestaurantRepositoryImpl implements RestaurantRepository {
    ...
    public Optional<Restaurant> findRestaurantInformation(Restaurant restaurant) {
        List<UUID> restaurantProducts = restaurantDataAccessMapper.toRestaurantProductsFrom(restaurant);
        ...
        return restaurantEntities.map(restaurantDataAccessMapper::toRestaurantFrom);
    }
}
