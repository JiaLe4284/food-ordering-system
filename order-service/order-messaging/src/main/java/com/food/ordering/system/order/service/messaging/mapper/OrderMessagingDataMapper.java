...
public class OrderMessagingDataMapper {
    public PaymentRequestAvroModel toPaymentRequestAvroModelFrom(OrderCreatedEvent orderCreatedEvent) {
    ...
    public PaymentRequestAvroModel toPaymentRequestAvroModelFrom(OrderCancelledEvent orderCancelledEvent) {
    ...
    toRestaurantApprovalRequestAvroModelFrom(OrderPaidEvent orderPaidEvent) {
