...
public class RestaurantMessagingDataMapper {
    public RestaurantApprovalResponseAvroModel toRestaurantApprovalResponseAvroModel(OrderApprovedEvent orderApprovedEvent) {
    ...
    public RestaurantApprovalResponseAvroModel toRestaurantApprovalResponseAvroModel(OrderRejectedEvent orderRejectedEvent) {
        return RestaurantApprovalResponseAvroModel.newBuilder()
                .setId(UUID.randomUUID().toString())
                .setSagaId("")
    ...
    public RestaurantApprovalRequest toRestaurantApproval(RestaurantApprovalRequestAvroModel restaurantApprovalRequestAvroModel) {
