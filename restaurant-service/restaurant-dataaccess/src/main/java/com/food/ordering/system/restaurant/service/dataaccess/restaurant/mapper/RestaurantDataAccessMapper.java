...
public class RestaurantDataAccessMapper {
    ...
    public OrderApprovalEntity toOrderApprovalEntity(OrderApproval orderApproval) {
    ...
    public OrderApproval toOrderApproval(OrderApprovalEntity orderApprovalEntity) {
