...
public class RestaurantDataMapper {
    public Restaurant toRestaurant(RestaurantApprovalRequest restaurantApprovalRequest) {
    ...
    public OrderEventPayload toOrderEventPayload(OrderApprovalEvent orderApprovalEvent) {
